...
This is an intermediate release for NAOJ for 1D sky subtraction study, survey simulation etc. For SIM2D and 2D DRP, all outputs will be defined in data model, and generated by these systems. If necessary, mock outputs are generated where no meaningful data can be produced.
